...
//******************************************************************************
    ...
    var scwBaseYear        = 1910;//scwDateNow.getFullYear()-10;
    ...
    //var scwDateDisplayFormat = 'mm/dd/yy';     // e.g. 'MMM-DD-YYYY' for the US
    //Modified by Prashant Dheer Gupta to convert today's date format
    var scwDateDisplayFormat = 'dd/mm/yyyy';     // e.g. 'DD-MM-YYYY' for the Australia
...
//var scwDateOutputFormat  = 'mm/dd/yy'; // e.g. 'MMM-DD-YYYY' for the US
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Drag Handle */'                                         +
            'td.scwDrag                 {background-color:  #FFFFFF;'   +
                                        'color:             #CCCCFF;}'  +
            '/* Week number heading */'                                 +
...
// ***************************
    ...
    if ((new Date(scwBaseYear + scwDropDownYears, 11, 32)) > scwDateNow &&
        ...
        {document.write(
                  "<tfoot class='scwFoot'>" +
                    "<tr class='scwFoot'>" +
                      "<td class='scwFoot' id='scwFoot' colspan='8'>"+ "</td>" +
                    "</tr>" +
                  "</tfoot>");
        }
