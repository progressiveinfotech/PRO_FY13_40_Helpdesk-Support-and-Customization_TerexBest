<%@ Page Language="C#" MasterPageFile="~/Master/MasterAdmin.master" AutoEventWireup="true" CodeFile="AddChangeStatus.aspx.cs" Inherits="admin_AddChangeStatus" Title="Untitled Page" %>
                        ...
                        <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>         
                                    ...
                                    <asp:RequiredFieldValidator ID="reqValStatus" 
                                        runat="server" 
                                        ControlToValidate="txtStatusName" 
                            ...
                            <tr>
                                ...
                                <td background="../images/tdimg.bmp" style="color:White;font-weight:bold;" align="left">
                                    <asp:Button ID="btnStatusAdd" runat="server" onclick="btnStatusAdd_Click" Text="Save"  />      
                            ...
                            <tr>
                                <td colspan="5" align="center"> 
                                    <asp:GridView ID="Statusgrdvw" 
                                        runat="server"  
                                        OnRowDeleting="Statusgrdvw_RowDeleting" 
                                        OnRowEditing="Statusgrdvw_RowEditing"
                                        OnRowCancelingEdit="Statusgrdvw_RowCancelingEdit" 
                                        OnRowUpdating="Statusgrdvw_RowUpdating"  
                                        OnPageIndexChanging="Statusgrdvw_PageIndexChanging"
                                        ...
                                        <Columns>
                                            <asp:BoundField HeaderText="Status Id"  DataField="changestatusid" ReadOnly="true" />
                                            <asp:TemplateField HeaderText="Status Name" >
                                                <ItemTemplate>
                                                    <asp:Label ID="lblStatusName" Text='<%# Eval("statusname") %>' runat="server"></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate >
                                                    <asp:TextBox ID="txtStatusName" runat="server" Text='<%# Bind("statusname") %>' MaxLength="50"></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
