<%@ Page Language="C#" MasterPageFile="~/Master/MasterAdmin.master" AutoEventWireup="true" CodeFile="AddSubcategory.aspx.cs" Inherits="admin_AddSubcategory" Title="Untitled Page" %>
...
<ContentTemplate>
    ...
    <tr>
        ...
        <td>
         ...
         <asp:TextBox ID="txtSubcategoryName" runat="server" Width="195" MaxLength="50"></asp:TextBox> &nbsp;<asp:RequiredFieldValidator ID="reqValSubcategory" runat="server" ControlToValidate="txtSubcategoryName" EnableClientScript="true"  SetFocusOnError="true"  ForeColor="Red"></asp:RequiredFieldValidator></td>
    ...
    <tr>
        ...
        <td >
           ...
           <asp:TextBox ID="txtSubcategorydesc" runat="server" Height="30px" 
   ...
   <tr><td>&nbsp;</td></tr>
    ...
    <tr><td colspan="5" align="center"> 
       <asp:GridView ID="subcategorygrdvw" runat="server"  CssClass="grid-view"
             OnRowEditing="subcategorygrdvw_RowEditing" OnRowCancelingEdit="subcategorygrdvw_RowCancelingEdit"
             OnRowUpdating="subcategorygrdvw_RowUpdating"  OnRowDeleting="subcategorygrdvw_RowDeleting"
               OnPageIndexChanging="subcategorygrdvw_PageIndexChanging" OnRowDataBound="subcategorygrdvw_RowDataBound"
