<%@ Page Language="C#" MasterPageFile="~/Master/MasterAdmin.master" AutoEventWireup="true" CodeFile="AddSlaDefinition.aspx.cs" Inherits="admin_AddSlaDefinition" Title="Untitled Page" %>
...
<ContentTemplate>
    ...
    <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0">
    <tr>
    <td colspan="5" valign="top"><asp:Label ID="lblErrorMsg" runat="server"  Font-Bold="true"  ForeColor="Red"></asp:Label></td>
    </tr>
    <tr>
        <td width="32%">
           &nbsp;</td>
     ...
     <tr>
        <td background="../images/tdimg.bmp" style="color:White;font-weight:bold;">
            &nbsp;Define Service Level Aggrement (SLA)</td>
            <td background="../images/tdimg.bmp" style="color:White;font-weight:bold;" align="right" > 
            <asp:LinkButton ID="lnkViewSla" runat="server" Text="[View SLA]" ForeColor="White" Font-Bold="true" CausesValidation="false" onclick="lnkViewSla_Click"></asp:LinkButton>
                    &nbsp;&nbsp;&nbsp;</td>
            
    </tr>
      <tr><td>&nbsp;</td></tr>
     <tr><td class="tdsubheading" colspan="5" align="left">
   &nbsp;&nbsp;<font class="mandatory">*</font>Select Customer &nbsp;&nbsp;<asp:DropDownList 
             ID="drpRegion" AutoPostBack="true" runat="server" onselectedindexchanged="drpRegion_SelectedIndexChanged" 
           ></asp:DropDownList>&nbsp;&nbsp;<asp:RequiredFieldValidator ID="reqValdrpCustomer" runat="server" EnableClientScript="true" ControlToValidate="drpRegion" ErrorMessage="Select Customer"   InitialValue="0"></asp:RequiredFieldValidator></td>                             
    </tr>
  
     
    <tr><td class="tdsubheading"  align="left">&nbsp;&nbsp;<font class="mandatory">*</font>Select Site to Apply Service Level Aggrement(SLA) </td>                             
     <td width="80%"><asp:DropDownList ID="drpSites"  runat="server" 
             ></asp:DropDownList>&nbsp;&nbsp;<asp:RequiredFieldValidator ID="reqValSite" runat="server" EnableClientScript="true" ControlToValidate="drpSites" ForeColor="Red" InitialValue="0"></asp:RequiredFieldValidator></td></tr>
       <tr><td>&nbsp;</td></tr>
        <tr>
    ...
    <tr><td>&nbsp;</td></tr>
     <tr>
        <td background="../images/tdimg.bmp" style="color:White;font-weight:bold;" colspan="5" >
            &nbsp;SLA Rules  - &nbsp;<font style=" font-size:smaller;">(To select priority and define resolution time)</font></td>
        ...
        <tr><td colspan="5">&nbsp;&nbsp;  <asp:Label ID="lblErrorTimeSelect" runat="server" ForeColor="Red"></asp:Label> <asp:RequiredFieldValidator ID="reqValtxtDays" runat="server" ControlToValidate="txtDays" ForeColor="Red"></asp:RequiredFieldValidator>
         ...
         <tr>
        <td colspan="5" valign="top">&nbsp;&nbsp;&nbsp;<font class="mandatory">*</font>Select Priority &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="drpPriority" runat="server"  ></asp:DropDownList>
        ...
        <td></td>
         ...
         <tr>
        <td colspan="5" valign="top">&nbsp;&nbsp;&nbsp;<cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" FilterType="Numbers" TargetControlID="txtDays" runat="server">
            </cc1:FilteredTextBoxExtender><font class="mandatory">*</font>Resolution time : &nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtDays" runat="server" Height="12px" MaxLength="3" Width="25px"></asp:TextBox>&nbsp;&nbsp;Days&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <td  colspan="5">
    ...
    <td  height="25px"  >&nbsp;&nbsp;&nbsp;<a href="#" ><strong><font color="#0066cc">Enable Level 2 Escalation </font> </strong></a></td>
       ...
       <table width="100%" align="center">
           <tr><td width="15%" valign="top">&nbsp;&nbsp;<asp:CheckBox ID="chkLevel2" runat="server" Text="" />
            ...
            <td width="85%">
            <asp:ListBox ID="listLevel2"  SelectionMode="Multiple" height="50px" Width="470px" runat="server"></asp:ListBox>
            </td></tr>
           <tr>
           <td></td>
           <td>
    ...
    <td  height="25px"  >&nbsp;&nbsp;&nbsp;<a href="#" ><strong><font color="#0066cc">Enable Level 3 Escalation </font> </strong></a></td>
       ...
       <table width="100%" align="center">
            ...
            <td width="85%">
            <asp:ListBox ID="listLevel3"  SelectionMode="Multiple" height="50px" Width="470px" runat="server"></asp:ListBox>
        ...
        <td background="../images/tdimg.bmp" style="color:White;font-weight:bold;">
            ...
            <td background="../images/tdimg.bmp" style="color:White;font-weight:bold;">
                <asp:Button ID="btnSave" runat="server" Text=" Save " onclick="btnSave_Click" 
                    ...
                    CausesValidation="false" runat="server" Text="Reset" 
