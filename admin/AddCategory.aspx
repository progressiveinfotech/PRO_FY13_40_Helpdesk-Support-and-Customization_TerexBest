<%@ Page Language="C#" MasterPageFile="~/Master/MasterAdmin.master" AutoEventWireup="true" CodeFile="AddCategory.aspx.cs" Inherits="admin_AddCategory" Title="Untitled Page" %>
                        ...
                        <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                                ...
                                <td background="../images/tdimg.bmp" style="color:White;font-weight:bold;" align="left">
                                    <asp:Button ID="btnCategoryadd" runat="server" onclick="btnCategoryadd_Click" Text="Save"/>      
                            ...
                            <tr>
                                <td colspan="5" align="center"> 
                                    <asp:GridView ID="Categorygrdvw" 
                                        runat="server"  
                                        CssClass="grid-view"
                                        OnRowDeleting="Categorygrdvw_RowDeleting" 
                                        OnRowEditing="Categorygrdvw_RowEditing"
                                        OnRowCancelingEdit="Categorygrdvw_RowCancelingEdit" 
                                        OnRowUpdating="Categorygrdvw_RowUpdating" 
                                        OnPageIndexChanging="Categorygrdvw_PageIndexChanging"
                                        ...
                                        <Columns>
                                        <asp:BoundField HeaderText="Category Id"  DataField="categoryid" ReadOnly="true" />
                                            <asp:TemplateField HeaderText="Category Name" >
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCategoryName" Text='<%# Eval("CategoryName") %>' runat="server"></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate >
                                                    <asp:TextBox ID="txtCategoryName" runat="server" Text='<%# Bind("CategoryName") %>' MaxLength="50"></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Category Description" >
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCategorydesc" Text='<%# Eval("categorydescription") %>' runat="server"></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate >
                                                    <asp:TextBox ID="txtCategorydesc" runat="server" Text='<%# Bind("categorydescription") %>' MaxLength="500"></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
