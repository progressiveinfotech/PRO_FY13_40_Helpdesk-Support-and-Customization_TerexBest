...
<tr>
 ...
 <tr><td>
  ...
  <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0">
    ...
    <td></td>
    <td><asp:LinkButton ID="lnkedit" runat="server" Text="[EDIT]"></asp:LinkButton></td>
    </tr>
    <tr>
 ...
 <tr>
        <td background="../images/tdimg.bmp" style="color:White;font-weight:bold;" width="100%">
            &nbsp;<asp:Button ID="btnAdd" runat="server" Text="Save" OnClick="btnAdd_Click" Visible="false"   /></td>
