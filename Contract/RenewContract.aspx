<%@ Page Language="C#" MasterPageFile="~/Master/MasterContract.master" AutoEventWireup="true" CodeFile="RenewContract.aspx.cs" Inherits="Contract_RenewContract" Title="Untitled Page" %>
    ...
    <tr>
        ...
        <td background="../images/tdimg.bmp" style="color:White;font-weight:bold;" align="left">
             ...
             <asp:Button ID="btnAdd" runat="server"  OnClientClick="javascript:dateValidation();"
                Text="Renew Contract" onclick="btnAdd_Click"  />      
