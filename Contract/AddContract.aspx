<%@ Page Language="C#" MasterPageFile="~/Master/MasterContract.master" AutoEventWireup="true" CodeFile="AddContract.aspx.cs" Inherits="Contract_AddContract" Title="Untitled Page" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<script  type="text/javascript" language="javascript" src="../JScript/scw.js"></script>
...
<ContentTemplate>
    ...
    <tr style="padding-top:10px">
        ...
        <td>
         ...
         <asp:TextBox ID="txtContractName" runat="server" Columns="70"  ></asp:TextBox> &nbsp;<asp:RequiredFieldValidator ID="reqValRegion" runat="server" ControlToValidate="txtContractName" EnableClientScript="true"  SetFocusOnError="true"  ErrorMessage="Enter Contract Name" ForeColor="Red"></asp:RequiredFieldValidator></td>
     ...
     <tr>
        ...
        <td>
          ...
          <asp:DropDownList ID="drpVendor" runat="server">
                ...
                onclick="lnkAddVendor_Click" ></asp:LinkButton>
        ...
        <td>
         <asp:TextBox ID="txtActiveFrom" runat="server" ToolTip="DD/MM/YYYY" ></asp:TextBox>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ErrorMessage="Enter Date" ControlToValidate="txtActiveFrom">
            </asp:RequiredFieldValidator>
        </td>
   ...
   <tr>
        ...
        <asp:TextBox ID="txtActiveTo" runat="server" ToolTip="DD/MM/YYYY" ></asp:TextBox>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                    ErrorMessage="Enter Date" ControlToValidate="txtActiveTo">
            </asp:RequiredFieldValidator>
     ...
     <tr style="padding-top:10px"><td valign="top" width="15%">&nbsp;&nbsp;<asp:CheckBox ID="chkLevel1" runat="server" Font-Bold="true" Text=" Enable Notification" />
           </td>
            <td width="85%">
    ...
    <tr>
        ...
        <td background="../images/tdimg.bmp" style="color:White;font-weight:bold;" align="left">
             ...
             <asp:Button ID="btnAdd" runat="server"  OnClientClick="javascript:dateValidation();"
                Text="Add Contract" onclick="btnAdd_Click"  />      
