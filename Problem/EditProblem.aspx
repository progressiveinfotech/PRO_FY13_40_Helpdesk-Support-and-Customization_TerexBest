       ...
       <Content></Content>
             ...
             <asp:Panel ID="panalsolution" runat="server" BorderWidth="1">
              <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr><td background="../images/tdimg.bmp" style="color:White;font-weight:bold;"  width="20%">&nbsp;<asp:Button runat="server" ID="problemrca" Text="Export To RCA" OnClick="problemrca_Click" /> </td></tr>
