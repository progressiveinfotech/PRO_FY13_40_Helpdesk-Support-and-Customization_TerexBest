<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="Viewrejectedcalls.aspx.cs" Inherits="Incident_Viewrejectedcalls" %>
...
<asp:Label ID="Lblmsg" runat="server" Visible="false"></asp:Label>
 <asp:GridView ID="gdvViewrejectedcalls" runat="server" CssClass="Gridview" AutoGenerateColumns="false"
            CellPadding="0" ForeColor="Black"  CellSpacing="0" onrowcommand="gdvViewrejectedcalls_RowCommand"
            GridLines="Both" BackColor="White" BorderColor="Black" BorderStyle="None" BorderWidth="1px" 
            PageSize="10" AllowPaging="true" Width="100%" onpageindexchanging="gdvViewrejectedcalls_PageIndexChanging" onrowdatabound="gdvViewrejectedcalls_RowDataBound">
  ...
  <%--  <asp:BoundField DataField="MailFrom" HeaderText="User Email" ItemStyle-HorizontalAlign="Center" />--%>
    ...
    <%--</ContentTemplate>
    <Triggers>
    <asp:AsyncPostBackTrigger ControlID="gdvViewrejectedcalls" EventName="RowCommand" />
    </Triggers>
