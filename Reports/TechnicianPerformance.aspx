<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TechnicianPerformance.aspx.cs" Inherits="Reports_TechnicianPerformance" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <tr><td>&nbsp;</td></tr>
            ...
            <tr >
             <td>&nbsp;&nbsp;Select Site &nbsp;&nbsp;&nbsp;
             <asp:DropDownList ID="drpSite" AutoPostBack="true" runat="server" 
                     onselectedindexchanged="drpSite_SelectedIndexChanged" Width="155px" ></asp:DropDownList>
            </td>
             <td>&nbsp;&nbsp;Select Technician &nbsp;&nbsp;
             <asp:DropDownList ID="drpTechnician" runat="server" Width="155px"
                      ></asp:DropDownList>
            </td>
            </tr>
             <tr><td>&nbsp;</td></tr>
